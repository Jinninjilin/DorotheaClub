...
<div class="containers">
    <h2 class="text-center">Mandalika</h2>
        ...
        <div class="row">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/mandalika1.jpg" alt="Mandalika"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Gendang Beleq</h1>
                            <p style="font-size: 16px;">Gendang beleq merupakan salah satu musik tradisional yang telah diwariskan orang terdahulu masyarakat Suku Sasak yang mendiami pulau Lombok, Nusa Tenggara Barat. Kelompok penabuh gendang ini biasanya terdiri dari belasan personel. Gendang beleq biasanya digunakan sebagai pengiring tradisi nyongkolan saat resepsi pernikahan. Namun, gendang beleq awalnya digunakan untuk pemberi semangat saat akan mengantar atau menyambut pasukan perang.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/mandalika2.jpg" alt="Mandalika"
                            style="width:350px;height:350px;">
                        </div>

                        <div class="flip-card-back">
                            <h1>Batik</h1>
                            <p style="font-size: 16px;">Batik sasambo merupakan batik khas NTB yang diinisiasi dari tiga etnis yakni suku Sasak (Lombok), suku Samawa (Sumbawa), dan suku Mbojo (Bima).
                                ...
                                Batik sasambo menjadi karya seni yang mempererat kerukunan, persatuan, dan kebersamaan ketiga suku terbesar di NTB tersebut.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/mandalika3.png" alt="Mandalika"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Fauna</h1>
                            <p style="font-size: 16px;">Fauna khas Nusa Tenggara Barat Rusa timor dipilih sebagai fauna khas di Nusa Tenggara Barat, disebabkan jenis fauna ini merupakan satwa liar yang harus dilindungi. Di samping itu, di provinsi ini banyak terdapat padang-padang rumput sehingga cocok untuk perkembangbiakannya. Rusa timor (Cervus timorensis) merupakan satwa liar yang berkerabat dekat dengan kancil dan kijang. Daerah penyebarannya meliputi Pulau Lombok dan Pulau Sumbawa.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div><h2 class="text-center">Baca yang lainnya</h2></div>
    <!-- card kecil -->
