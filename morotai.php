...
<div class="container-fluid">
  <h1 class="text-center">Morotai</h1>
  <div class="row pt-2">
    <div class="kartu mx-auto col-12 col-lg-4">
      <input type="checkbox" id="card1" class="more" aria-hidden="true">
      <div class="content">
        <div class="front" style="background-image: url('poster/tarimorotai.jpg')">
          <div class="inner">
            <h2>Tarian</h2>
            <div class="rating">
          ...
          <div class="inner">
            <div class="description">
              <p>
                ...
                perayaan adat. Biasanya, tarian ini dibawakan oleh 30 pria dan wanita. Tarian ini dilakukan
                secara berpasangan dengan iringan musik drum, flute, bia (sejenis musik tiup). Para penari pria
                biasanya mengenakan parang dan salawaku (perisai) sedangkan penari wanita menggunakan lenso
              (saputangan).</p>
            </div>
            <div class="location">Tarian Cakalele</div>
    ...
    <div class="kartu mx-auto col-12 col-lg-4">
      ...
      <div class="content">
        <div class="front" style="background-image: url('poster/festivalmorotai.jpg')">
          <div class="inner">
            <h2>Festival</h2>
            <div class="rating">
              <i class="fas fa-star"></i>
        ...
        <div class="back">
          <div class="inner">
            ...
            <div class="description">
              <p>Tokuwela Morotai Festival diselenggarakan di Kabupaten Pulau Morotai pada tanggal 14 Mei
                2022 secara hybrid. Bertempat di Ex-Sail Juanga, acara puncak Tokuwela Morotai Festival ini mengajak
                para wisatawan untuk mengenal wisata bahari, budaya, dan sejarah Pulau Morotai. Ada sekitar 1500
                partisipan yang menampilkan beragam jenis kesenian tarian tradisional. Ada juga penampilan atraksi budaya
              dan tarian kolosal khas Pulau Morotai seperti tari dana-dana, lalaweda, soya, saloi, dan lain sebagainya</p>
            </div>
            <div class="location">Tokuwela Morotai Festival</div>
    ...
    <div class="kartu mx-auto col-12 col-lg-4">
      ...
      <div class="content">
        <div class="front" style="background-image: url('poster/batikmorotai.jpg')">
          <div class="inner">
            <h2>Batik</h2>
            <div class="rating">
              <i class="fas fa-star"></i>
        ...
        <div class="back">
          <div class="inner">
            <div class="description">
              <p>Kain batik morotai sangat identik dengan corak batik parang, corak tanaman dan lain sebagainya.
                Selain itu, batik Morotai juga memiliki ciri khas tersendiri sebab akan menggambar beberapa
                rempah-rempah. Biasanya yang kerap kali digambar adalah corak cengkeh, corak dari pala bahkan ada juga
                corak yaitu burung bidadari. Kain batik ini akan sangat bagus jika digunakan sebagai baju bersama
              dengan keluarga.</p>
            </div>
            <div class="location">Batik Morotai</div>
