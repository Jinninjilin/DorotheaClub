...
<div class="containers">
    <h2 class="text-center">Tanjung Kelayang</h2>
        ...
        <div class="row">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/tanjungtarian.jpg" alt="candi borobudur"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Tari Sepen</h1>
                            <p style="font-size: 16px;">Tari sepen adalah tari tradisional Belitung yang menggambarkan tentang bergaulan di lingkungan masyarakat Belitung. Tari sepen mengandung unsur-unsur pencak silat sebagai dasar pijakannya, gerakannya pun sangat dominan dengan kelincahan kaki dan tangan. Dasar gerakan tari sepen adalah gerakan kaki seperti menyilang, melompat, dan menjijnjit.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/tanjungmakanan.jpeg" alt="candi borobudur"
                            style="width:350px;height:350px;">
                        </div>

                        <div class="flip-card-back">
                            <h1>Ketam Isi</h1>
                            <p style="font-size: 16px;">Ketam dalam Bahasa Belitung memiliki arti 'kepiting rajungan isi'. Produk ini merupakan olahan unik yang terbuat dari daging kepiting dicampur dengan telur, bawang putih, bumbu pilihan, dan daun seledri.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/tanjungbatik.jpeg" alt="candi borobudur"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Wayang</h1>
                            <p style="font-size: 16px;">Sementara Batik Sepiak atau disebut juga dengan Sepiak Belitong memiliki motif orisinal seperti motif daun simpor. Daun simpor begitu lekat dengan keseharian masyarakat Bangka Belitung, karena digunakan sebagai alas makan, wadah pembungkus lontong serta sayur, dan lain sebagainya. Dengan motif unik tersebut, Sepiak Belitong mengangkat khasanah budaya lokal Bangka Belitung. Selain itu, warna kain yang cerah membuat batik asal Bangka Belitung ini berbeda dari batik lainnya.</p>
                        </div>
                    </div>
                </div>
            </div>
