...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/subhal.css">
</head>
...
<div class="containers">
    <h2 class="text-center">Raja Ampat</h2>
        ...
        <div class="row">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/rajaampatbatik.jpg" alt="batik raja ampat"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Batik khas Raja Ampat</h1>
                            <p style="font-size: 16px;">Batik Raja Ampat adalah batik yang berasal dari kepulauan
                                Raja Ampat, Papua Barat, Indonesia. Motif batik Raja Ampat menggambarkan kehidupan
                                bahari di kepulauan Raja Ampat, yang terkenal dengan terumbu karang dan taman
                                lautnya yang indah. Motif-motif batik Raja Ampat yang populer antara lain burung
                                cenderawasih, kerang, ikan, dan cum-cumi, serta batik kupu-kupu. Batik Raja
                                Ampat juga merupakan bagian dari warisan budaya takbenda UNESCO yang ditetapkan pada
                                tahun 2009.
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/sagubakar.jpg" alt="makanan khas raja ampat"
                            style="width:350px;height:350px;">
                        </div>

                        <div class="flip-card-back">
                            <h1>Makanan : Gani Nu </h1>
                            <p style="font-size: 16px;">Gani Nu adalah makanan khas Raja Ampat yang terbuat dari
                                sagu dan daging Bia Kodok. Bia Kodok adalah kerang besar yang hidup di sekitar
                                tanaman bakau. Cara membuat Gani Nu adalah dengan mencampurkan sagu basah
                                dengan kelapa parut dan daging Bia Kodok yang telah direbus.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/festivalrajaampat.jpg" alt="festival raja ampat"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Festival</h1>
                            <p style="font-size: 16px;">Festival Pesona Raja Ampat adalah sebuah acara tahunan yang
                                diadakan di Raja Ampat, Papua Barat, Indonesia. Festival ini menampilkan keindahan
                                alam dan kekayaan budaya Raja Ampat, serta berbagai kegiatan menarik seperti Wild
                                Life di Kawasan Ekosistem Hutan, kegiatan air, Island Hopping, penampilan seni dan
                            budaya, pameran UMKM & Ekraf, serta panggung hiburan yang meriah.</p>
                        </div>
                    </div>
                </div>
            </div>
