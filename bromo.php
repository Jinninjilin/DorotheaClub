...
<div class="container-fluid">
  <h1 class="text-center">Bromo</h1>
  <div class="row pt-2">
    <div class="kartu mx-auto col-12 col-lg-4">
      <input type="checkbox" id="card1" class="more" aria-hidden="true">
      <div class="content">
        <div class="front" style="background-image: url('poster/bromomakanan.jpeg')">
          <div class="inner">
            <h2>Makanan</h2>
            <div class="rating">
        ...
        <div class="back">
          <div class="inner">
            <div class="description">
              <p>Iga Pasir Bromo ini berbeda dengan menu iga pada umumnya. Yang menjadi unik dan berbeda adalah cara
                memasak dan cita rasa yang khas dari Bromo. Cara memasak Iga Pasir Bromo ini menjadi unik karena
                ditungkunya terdapat pasir dan rasa nya yang panas dan pedas ini membuat iga yang satu ini sangat
              cocok disantap ketika berada di Bromo.</p>
            </div>
            <div class="location">Iga Pasir</div>
    ...
    <div class="kartu mx-auto col-12 col-lg-4">
      ...
      <div class="content">
        <div class="front" style="background-image: url('poster/bromofestival.jpg')">
          <div class="inner">
            <h2>Festival</h2>
            <div class="rating">
              <i class="fas fa-star"></i>
        ...
        <div class="back">
          <div class="inner">
            ...
            <div class="description">
              <p>Festival Yadya Kasada adalah Upacara Adat Suku Tengger Gunung Bromo. Suku Tengger Gunung Bromo
                merupakan salah satu suku tua di Pulau Jawa. Setiap bulan ke-12 (Kasada) hari-14 dalam penanggalan
                Tengger diadakan upacara sesembahan atau sesajen untuk Sang Hyang Widhi dan para leluhur (Dewa
                Kusuma), yang diyakini berasal dari kisah Rara Anteng (Putri Raja Majapahit) dan Jaka Seger (Putra
              Brahmana).</p>
            </div>
            <div class="location">Yadnya Kasada</div>
    ...
    <div class="kartu mx-auto col-12 col-lg-4">
      ...
      <div class="content">
        <div class="front" style="background-image: url('poster/batikbromo.jpeg')">
          <div class="inner">
            <h2>Batik</h2>
            <div class="rating">
              <i class="fas fa-star"></i>
        ...
        <div class="back">
          <div class="inner">
            <div class="description">
              <p>Ciri khas batik Kabupaten Probolinggo terdapat pada warna dan motifnya. Untuk warna cerah, batik
                Kabupaten Probolinggo sangat kuat pada warna hijau, merah, kuning. Sementara untuk warna gelap atau
                teduh, ada pada warna hitam, maroon dan violet. Sedangkan untuk warna lembut, diwakili dengan warna
              tosca, turkish dan wortel.</p>
            </div>
            <div class="location">Batik khas Bromo</div>
