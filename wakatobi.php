...
<div class="containers">
    <h2 class="text-center">Wakatobi</h2>
        ...
        <div class="row">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/batikwakatobi.png" alt="batik wakatobi"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Batik khas Wakatobi</h1>
                            <p style="font-size: 16px;">Batik khas Wakatobi yang memiliki motif yang melambangkan
                                keindahan pesisir pulau Wakatobi. Simbol daun Patra mengacu pada kesadaran diri dan
                                keilahian. Batik ini diciptakan oleh produsen lokal sebagai motif batik khas Daerah
                            Khusus Wakatobi, Sulawesi Tenggara </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/makananwakatobi.jpg" alt="makanan wakatobi"
                            style="width:350px;height:350px;">
                        </div>

                        <div class="flip-card-back">
                            <h1>Makanan : Ikan Bakar Colo-colo</h1>
                            <p style="font-size: 16px;">Ikan Bakar Colo-Colo adalah makanan khas Ambon, Maluku,
                                Indonesia. Ikan yang biasanya digunakan adalah ikan lema atau ikan kembung. Ikan
                                bakar colo-colo memiliki cita rasa yang pedas dan segar berkat sambal colo-colo yang
                                digunakan sebagai bumbu. Sambal colo-colo terbuat dari cabai, bawang merah, bawang
                                putih, tomat, dan air jeruk nipis.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/wakatobifestival.jpg" alt="festival wakatobi"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Wakatobi Wave Festivel</h1>
                            <p style="font-size: 16px;">Wakatobi Wave Festival adalah sebuah acara tahunan yang
                                diadakan di Wakatobi, Sulawesi Tenggara, Indonesia. Acara ini menampilkan keindahan
                                bawah laut dan kekayaan budaya Sulawesi Tenggara, serta berbagai kegiatan menarik
                                seperti Wild Life di Kawasan Ekosistem Hutan, kegiatan air, Island Hopping,
                            penampilan seni dan budaya, pameran UMKM & Ekraf, serta panggung hiburan yang meriah.</p>
                        </div>
                    </div>
                </div>
            </div>
