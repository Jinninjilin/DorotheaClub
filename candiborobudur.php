...
<div class="containers">
    <h2 class="text-center">Candi Borobudur</h2>
        ...
        <div class="row">
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back">
                            <h1>Batik Parang</h1>
                            <p style="font-size: 16px;">Motif Parang adalah salah satu motif batik tertua di
                                Indonesia yang sudah ada sejak
                                zaman Keraton Mataram. Nama motif Parang diambil dari kata Pereng yang berarti
                                lereng. Hal ini sesuai dengan corak Perengan yang berbentuk sebuah garis menurun
                                dari tinggi ke rendah secara diagonal, dengan ciri khas susunan motif seperti huruf
                            S yang saling menjalin dan tidak terputus.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/candimakanan.jpg" alt="candi borobudur"
                            style="width:350px;height:350px;">
                        </div>

                        <div class="flip-card-back">
                            <h1>Makanan : Ndas Beong</h1>
                            <p style="font-size: 16px;">Ikan Beong adalah sejenis ikan yang hanya bisa ditemukan di
                                Sungai Progo. Ikan ini
                                dimasak dengan rempah-rempah istimewa seperti lengkuas, sereh, jahe dan daun bawang
                                yang menciptakan menu ikan yang begitu lembut dan sedap.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front" style="align-items: center;">
                            <img src="poster/candiwayang.jpg" alt="candi borobudur"
                            style="width:350px;height:350px;">
                        </div>
                        <div class="flip-card-back">
                            <h1>Wayang</h1>
                            <p style="font-size: 16px;">Wayang adalah seni pertunjukan tradisional Indonesia yang
                                menggunakan boneka kayu
                                atau kulit yang dimainkan oleh dalang. Wayang khas Borobudur adalah wayang yang
                                terdapat pada relief Candi Borobudur, candi Buddha terbesar di dunia yang terletak
                                di Kabupaten Magelang, Jawa Tengah. Relief Candi Borobudur terdiri dari 2.672
                            panel relief yang menggambarkan cerita-cerita dari ajaran Buddha</p>
                        </div>
                    </div>
                </div>
            </div>
